...
{
    public static class SeedData ///static ca o folosim in alta parte
    {
        public static void Initialize(IServiceProvider serviceProvider)
        {
                ...
                <DbContextOptions<ApplicationDbContext>>()))
            {
                ...
                context.Roles.AddRange(
                    ...
                    new IdentityRole { Id = "2c5e174e-3b0e-446f-86af483d56fd7211", Name = "Organiser", NormalizedName = "Organiser".ToUpper() },
                ...
                context.Users.AddRange(
                   ...
                   new ApplicationUser
                   {
                       ...
                       PasswordHash = hasher.HashPassword(null,"Organiser1!")
                   },
                    new ApplicationUser
                    {
